...
namespace PluginHub.Infrastructure
{
    ...
    public class EngineContext
    {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                // 通过 ConfigurationManager.GetSection("PluginHubConfig")  获取的配置实例 除非 web.config 更新，否则单例，始终返回的同一实例
                var config = ConfigurationManager.GetSection("PluginHubConfig") as PluginHubConfig;
