    ...
    public class Tools
    {
        ...
        public static Dictionary<string, string> ObjectToDictionary(object attribute)
        {
            ...
            foreach (var item in fields)
            {
                ...
                // 等价于 .net 4.5 的 item.GetValue(attribute), 其内部就是调取了 GetValue(obj, null);
                di.Add(Name, item.GetValue(attribute, null).ToString());
            }
        ...
        public static string Post(string url, object parameter)
        {
            ...
            if (parameter != null)
            {
                ...
                foreach (var item in fields)
                {
                    PostVars.Add(item.Name, item.GetValue(parameter, null).ToString());
                }
            }
